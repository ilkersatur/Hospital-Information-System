...
namespace WebApp.Migrations
{
    ...
    [Migration("20230119091511_Baslangic")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoliklinikRandevuTanimi", b =>
                {
                    b.Property<int>("PolikliniklerPoliklinikID")
                        .HasColumnType("int");

                    b.Property<int>("RandevularTanimlariRandevuTanimiID")
                        .HasColumnType("int");

                    b.HasKey("PolikliniklerPoliklinikID", "RandevularTanimlariRandevuTanimiID");

                    b.HasIndex("RandevularTanimlariRandevuTanimiID");

                    b.ToTable("PoliklinikRandevuTanimi");
                });
            ...
            modelBuilder.Entity("PoliklinikRandevuTanimi", b =>
                {
                    b.HasOne("WebApp.Models.Poliklinik", null)
                        .WithMany()
                    ...
                    b.HasOne("WebApp.Models.RandevuTanimi", null)
                        .WithMany()
                        .HasForeignKey("RandevularTanimlariRandevuTanimiID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
